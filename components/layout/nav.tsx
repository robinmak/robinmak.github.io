...
export function Nav(): ReactNode {
  ...
  useLayoutEffect(() => {
    ...
    // Layout measurement synced to state for the animated pill indicator.
    // The updater is a no-op when the rect is unchanged, so this does not
    // cause the cascading re-renders the rule guards against.
